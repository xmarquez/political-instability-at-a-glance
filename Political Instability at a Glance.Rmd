...
# countries <- levels(factor(polity_cases$country))[ !(levels(factor(polity_cases$country)) %in% c("Baden","Great Colombia","Two Sicilies","Württemberg","Kosovo","Modena","Montenegro","Papal States","Parma","Saxony","Tuscany","United Provinces of Central America")) ]
# 
