...
We can also take a look at the more in-depth picture one can assemble from these datasets; one can get a sort of "geological" picture by unrolling the traces of history in these quantitative datasets. Here's Argentina, for example:

(How to read the picture: most recent events recorded are at the top. The black line represents the Polity score for the country; to the right is "more democratic," to the left "more autocratic." The jagged line in the middle with the light grey ribbon around it)
(Auto-generated deep histories for all countries in the Polity datasets are available [in the GitHub repository for this post](https://github.com/xmarquez/political-instability-at-a-glance/tree/master/Histories%20of%20instability), or through the GitHub repository for this post) 
[Haiti](https://github.com/xmarquez/political-instability-at-a-glance/blob/master/Histories%20of%20instability/Haiti.png) and the [Dominican Republic](https://github.com/xmarquez/political-instability-at-a-glance/blob/master/Histories%20of%20instability/Dominican%20Republic.png) are especially striking: And here are [Venezuela](https://github.com/xmarquez/political-instability-at-a-glance/blob/master/Histories%20of%20instability/Venezuela.png), [the United States](https://github.com/xmarquez/political-instability-at-a-glance/blob/master/Histories%20of%20instability/United%20States%20of%20America.png), [New Zealand](https://github.com/xmarquez/political-instability-at-a-glance/blob/master/Histories%20of%20instability/New%20Zealand.png). And here is [Spain](https://github.com/xmarquez/political-instability-at-a-glance/blob/master/Histories%20of%20instability/Spain.png)
...
ggplot()  + 
  ...
  theme_bw()
```
Code for all the graphs in this post is available at [this Github repository](https://github.com/xmarquez/political-instability-at-a-glance). The vast majority of the code is basically data-munging; you will need to download some of the datasets separately. (See the code for details).
